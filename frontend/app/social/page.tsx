...
export default function SocialPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'overview' | 'pipeline' | 'discover' | 'discovered' | 'leads' | 'profiles' | 'drafts' | 'sent' | 'profile_emails' | 'settings'
  >('overview')
  ...
  useEffect(() => {
    ...
    const handleTabChange = (e: CustomEvent) => {
      ...
      if (tabId && ['overview', 'pipeline', 'discover', 'discovered', 'leads', 'profiles', 'drafts', 'sent', 'profile_emails', 'settings'].includes(tabId)) {
  ...
  const handleTabChange = (tab: string) => {
    setActiveTab(tab as 'overview' | 'pipeline' | 'discover' | 'discovered' | 'leads' | 'profiles' | 'drafts' | 'sent' | 'profile_emails' | 'settings')
  }
