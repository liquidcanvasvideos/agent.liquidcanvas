...
import SocialProfileEmailsTable from '@/components/SocialProfileEmailsTable'
...
export default function SocialPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'overview' | 'pipeline' | 'discover' | 'discovered' | 'leads' | 'profile_emails' | 'profiles' | 'drafts' | 'sent' | 'settings'
  >('overview')
  ...
  useEffect(() => {
    ...
    const handleTabChange = (e: CustomEvent) => {
      ...
      if (tabId && ['overview', 'pipeline', 'discover', 'discovered', 'leads', 'profile_emails', 'profiles', 'drafts', 'sent', 'settings'].includes(tabId)) {
  ...
  const socialTabs = [
    ...
    { id: 'profile_emails', label: 'Profile Emails', icon: Mail },
  ...
  const handleTabChange = (tab: string) => {
    setActiveTab(tab as 'overview' | 'pipeline' | 'discover' | 'discovered' | 'leads' | 'profile_emails' | 'profiles' | 'drafts' | 'sent' | 'settings')
  }
      ...
      <div className="flex-1 lg:ml-64 flex flex-col">
        ...
        <main className="flex-1 px-3 sm:px-4 py-3 overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            ...
            {activeTab === 'profile_emails' && <SocialProfileEmailsTable />}
